...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
                ...
                <div className="relative w-full h-[60vh] md:h-[80vh]">
                  ...
                  <div className="relative h-full flex flex-col items-start justify-end p-4 md:p-12 lg:p-24">
                    <div className="max-w-2xl text-left">
                      ...
                      <p className="mt-4 text-base sm:text-lg text-foreground/90">
                        {slide.description}
                      </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-headline tracking-tighter sm:text-4xl md:text-5xl">Featured Styles</h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Handpicked for you. Discover our most popular and trending wigs of the season.
              </p>
            </div>
          </div>
          <div className="mx-auto max-w-6xl px-0 sm:px-6 lg:px-8 pt-12">
            <Carousel
              opts={{
                align: "start",
                loop: true,
            ...
            >
              <CarouselContent className="-ml-2 md:-ml-4">
                {featuredProducts.map((product) => (
                  <CarouselItem key={product.id} className="basis-1/2 md:basis-1/2 lg:basis-1/3 pl-2 md:pl-4">
      ...
      <section className="w-full py-12 md:py-24">
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl font-headline tracking-tighter text-center sm:text-4xl md:text-5xl mb-12">What Our Customers Say</h2>
