        ...
        <section className="mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="bg-card p-8 rounded-lg shadow-sm">
              <h2 className="text-3xl font-headline mb-6 text-foreground">Location Details</h2>
        ...
        <div className="grid grid-cols-1 gap-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="order-2 md:order-1">
              <h3 className="text-3xl font-headline text-foreground mb-4">Try Any Wigs You Want</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <h3 className="text-3xl font-headline text-foreground mb-4">Professional Stylists Are Here For You</h3>
              ...
              <p className="text-lg text-muted-foreground mt-4">Trust us with all your styling needs! <br /><em className="text-sm">*Advance booking is recommended.</em></p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
             <div className="order-2 md:order-1">
              <h3 className="text-3xl font-headline text-foreground mb-4">We Cherish Your Feedback</h3>
          ...
          {/* Patronage Reward */}
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <h3 className="text-3xl font-headline text-foreground mb-4">Patronage Reward</h3>
              <p className="text-lg text-muted-foreground mb-4">
